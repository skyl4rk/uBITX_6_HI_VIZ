...
const byte VFOA_LEFT = BUTTON_WIDTH / 4;
const byte VFOA_TOP = BUTTON_HEIGHT* 1.3;// BUTTON_HEIGHT + (BUTTON_HEIGHT - VFOA_SIZE * CHAR_HEIGHT)/2;
const byte VFOA_SIZE = 7;
const byte VFOB_SIZE = 3;

const byte VFOB_LEFT = BUTTON_WIDTH * 3;
const byte VFOB_TOP = BUTTON_HEIGHT / 2;
...
const unsigned BANNER_BG = 0x000F;
const unsigned BANNER_FG = RGB565(255,255,0);
